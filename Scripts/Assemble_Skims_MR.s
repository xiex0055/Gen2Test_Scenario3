...
;   period    (@period@) = 'am'/'op'
;
;  Transit Skim Files           = <iteration>_<period>_MR.skm
;  Transit Fare Files           = <iteration>_<period>_MR.FAR
; Output File:
;  Combined Transit Skims       = <iteration>TRN<Period>_MR.SKM, MO = 1-48,
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
RUN PGM=MATRIX
 MATI[1]=%_iter_%_@TIME_PERIOD@_WK_MR.SKM
 MATI[2]=%_iter_%_@TIME_PERIOD@_WK_MR.FAR
 MATI[3]=%_iter_%_@TIME_PERIOD@_DR_MR.SKM
 MATI[4]=%_iter_%_@TIME_PERIOD@_DR_MR.FAR
 MATI[5]=%_iter_%_@TIME_PERIOD@_KR_MR.SKM
 MATI[6]=%_iter_%_@TIME_PERIOD@_KR_MR.FAR
 MATO[1]=%_iter_%_TRN@TIME_PERIOD@_MR.SKM, MO = 1-48,
