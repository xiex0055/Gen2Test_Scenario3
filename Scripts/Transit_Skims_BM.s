...
JLOOP
; If the shortest path found in path building, which builds paths for all bus 
; and Metro modes, has a Metro component = 0 or a bus component = 0, 
; then this path will not be considered in the BM category 
; and it will be equal to zero for this specific category, 
; but will be included in AB or MR category.
