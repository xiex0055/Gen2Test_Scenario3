...
;   period    (@period@) = 'am'/'op'
;
;  Transit Skim Files           = <iteration>_<period>_BM.skm
;  Transit Fare Files           = <iteration>_<period>_BM.FAR
; Output File:
;  Combined Transit Skims       = <iteration>TRN<Period>_BM.SKM, MO = 1-48,
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
RUN PGM=MATRIX
 MATI[1]=%_iter_%_@TIME_PERIOD@_WK_BM.SKM
 MATI[2]=%_iter_%_@TIME_PERIOD@_WK_BM.FAR
 MATI[3]=%_iter_%_@TIME_PERIOD@_DR_BM.SKM
 MATI[4]=%_iter_%_@TIME_PERIOD@_DR_BM.FAR
 MATI[5]=%_iter_%_@TIME_PERIOD@_KR_BM.SKM
 MATI[6]=%_iter_%_@TIME_PERIOD@_KR_BM.FAR
 MATO[1]=%_iter_%_TRN@TIME_PERIOD@_BM.SKM, MO = 1-48,
